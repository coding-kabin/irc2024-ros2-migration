...
node = rclpy.create_node("gui_test", anonymous=True)
...
# Sensors publisher
pub_sensor = node.create_publisher(sensor_msg, queue_size=1, "/sensors")
pub_spectro = node.create_publisher(spectro_msg, queue_size=1, "/spectrometer")

flag_sub = node.create_subscription(Int8, '/flag_topic', flag_func)

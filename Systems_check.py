...
if __name__=='__main__':
    rclpy.init()
    node = rclpy.create_node("Test_drive")
    ...
    pub = node.create_publisher(Int16MultiArray, queue_size=1, "/control1")
    msg.data=[255,0,0]
    for i in range(1,3):
        pub.publish(msg)
        time.sleep(1)
    ...
    pub2=node.create_publisher(Int16MultiArray, queue_size=1, "/control2")
    msg.data=[0,0,2]
    msg2.data=[0,0,0,0,1]
    for i in range(1,3):
        pub.publish(msg)

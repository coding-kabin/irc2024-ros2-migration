...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef std::shared_ptr< ::sensor_msgs::msg::BatteryState_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sensor_msgs::msg::BatteryState_<ContainerAllocator> const> ConstPtr;

}; // struct BatteryState_

typedef ::sensor_msgs::msg::BatteryState_<std::allocator<void> > BatteryState;

typedef std::shared_ptr< ::sensor_msgs::msg::BatteryState > BatteryStatePtr;
typedef std::shared_ptr< ::sensor_msgs::msg::BatteryState const> BatteryState::ConstSharedPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sensor_msgs::msg::BatteryState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sensor_msgs::msg::BatteryState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sensor_msgs::msg::BatteryState_<ContainerAllocator1> & lhs, const ::sensor_msgs::msg::BatteryState_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::msg::BatteryState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::msg::BatteryState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::msg::BatteryState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::msg::BatteryState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::msg::BatteryState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::msg::BatteryState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sensor_msgs::msg::BatteryState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sensor_msgs::msg::BatteryState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4ddae7f048e32fdaULL;
  static const uint64_t static_value2 = 0x22cac764685e3974ULL;
};

template<class ContainerAllocator>
struct DataType< ::sensor_msgs::msg::BatteryState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sensor_msgs::msg::BatteryState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sensor_msgs::msg::BatteryState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sensor_msgs::msg::BatteryState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sensor_msgs::msg::BatteryState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;

...
struct CameraInfo_
{
  ...
  _binning_y_type binning_y;
   ...
   typedef  ::sensor_msgs::msg::RegionOfInterest_<ContainerAllocator>  _roi_type;
  _roi_type roi;
  ...
  typedef std::shared_ptr< ::sensor_msgs::msg::CameraInfo_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sensor_msgs::msg::CameraInfo_<ContainerAllocator> const> ConstPtr;

}; // struct CameraInfo_

typedef ::sensor_msgs::msg::CameraInfo_<std::allocator<void> > CameraInfo;

typedef std::shared_ptr< ::sensor_msgs::msg::CameraInfo > CameraInfoPtr;
typedef std::shared_ptr< ::sensor_msgs::msg::CameraInfo const> CameraInfo::ConstSharedPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sensor_msgs::msg::CameraInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sensor_msgs::msg::CameraInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sensor_msgs::msg::CameraInfo_<ContainerAllocator1> & lhs, const ::sensor_msgs::msg::CameraInfo_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::msg::CameraInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::msg::CameraInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::msg::CameraInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::msg::CameraInfo_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::msg::CameraInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::msg::CameraInfo_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sensor_msgs::msg::CameraInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sensor_msgs::msg::CameraInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc9a58c1b0b154e0eULL;
  static const uint64_t static_value2 = 0x6da7578cb991d214ULL;
};

template<class ContainerAllocator>
struct DataType< ::sensor_msgs::msg::CameraInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sensor_msgs::msg::CameraInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sensor_msgs::msg::CameraInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sensor_msgs::msg::CameraInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sensor_msgs::msg::CameraInfo_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "roi: ";
    s << std::endl;
    Printer< ::sensor_msgs::msg::RegionOfInterest_<ContainerAllocator> >::stream(s, indent + "  ", v.roi);
  }
};

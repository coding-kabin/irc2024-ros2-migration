...
struct Imu_
{
  ...
  typedef std::shared_ptr< ::sensor_msgs::msg::Imu_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sensor_msgs::msg::Imu_<ContainerAllocator> const> ConstPtr;

}; // struct Imu_

typedef ::sensor_msgs::msg::Imu_<std::allocator<void> > Imu;

typedef std::shared_ptr< ::sensor_msgs::msg::Imu > ImuPtr;
typedef std::shared_ptr< ::sensor_msgs::msg::Imu const> Imu::ConstSharedPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sensor_msgs::msg::Imu_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sensor_msgs::msg::Imu_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sensor_msgs::msg::Imu_<ContainerAllocator1> & lhs, const ::sensor_msgs::msg::Imu_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::msg::Imu_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::msg::Imu_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::msg::Imu_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::msg::Imu_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::msg::Imu_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::msg::Imu_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sensor_msgs::msg::Imu_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sensor_msgs::msg::Imu_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6a62c6daae103f4fULL;
  static const uint64_t static_value2 = 0xf57a132d6f95cec2ULL;
};

template<class ContainerAllocator>
struct DataType< ::sensor_msgs::msg::Imu_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sensor_msgs::msg::Imu_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sensor_msgs::msg::Imu_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sensor_msgs::msg::Imu_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sensor_msgs::msg::Imu_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;

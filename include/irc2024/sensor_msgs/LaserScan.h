...
struct LaserScan_
{
  ...
  typedef std::shared_ptr< ::sensor_msgs::msg::LaserScan_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sensor_msgs::msg::LaserScan_<ContainerAllocator> const> ConstPtr;

}; // struct LaserScan_

typedef ::sensor_msgs::msg::LaserScan_<std::allocator<void> > LaserScan;

typedef std::shared_ptr< ::sensor_msgs::msg::LaserScan > LaserScanPtr;
typedef std::shared_ptr< ::sensor_msgs::msg::LaserScan const> LaserScan::ConstSharedPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sensor_msgs::msg::LaserScan_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sensor_msgs::msg::LaserScan_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sensor_msgs::msg::LaserScan_<ContainerAllocator1> & lhs, const ::sensor_msgs::msg::LaserScan_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::msg::LaserScan_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sensor_msgs::msg::LaserScan_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::msg::LaserScan_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sensor_msgs::msg::LaserScan_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::msg::LaserScan_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sensor_msgs::msg::LaserScan_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sensor_msgs::msg::LaserScan_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sensor_msgs::msg::LaserScan_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x90c7ef2dc6895d81ULL;
  static const uint64_t static_value2 = 0x024acba2ac42f369ULL;
};

template<class ContainerAllocator>
struct DataType< ::sensor_msgs::msg::LaserScan_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sensor_msgs::msg::LaserScan_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sensor_msgs::msg::LaserScan_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sensor_msgs::msg::LaserScan_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sensor_msgs::msg::LaserScan_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;

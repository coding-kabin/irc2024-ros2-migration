...
class JoystickControl:
     def __init__(self):
          ...
          self.pub = node.create_publisher(Int16MultiArray, queue_size=1, "/ld_mega")
...
pub = node.create_publisher(Int16MultiArray, queue_size=1, "/mega")
rate = rospy.Rate(10)
if __name__ == '__main__':
    rclpy.init()
    node = rclpy.create_node("LD_setup_mega", anonymous=True)

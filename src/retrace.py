...
class RemoteConnectionManager:
    def __init__(self):
        rclpy.init()
        node = rclpy.create_node('remote_connection_manager', anonymous=True)
        ...
        self.path_retrace_pub = node.create_publisher(String, queue_size=10, '/rover')
...
if __name__ == '__main__':
    ...
    node.create_subscription(String, '/mavros/gpsstatus/gps1/raw', remote_connection_manager.gps_callback)
    node.create_subscription(String, '/mavros/gpsstatus/gps1/raw', remote_connection_manager.current_gps)
